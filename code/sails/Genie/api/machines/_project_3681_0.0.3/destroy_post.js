module.exports = {
  ...
  "fn": function(inputs, exits, env) {
    env.sails.models.post.destroy(inputs.criteria, env.sails.util.omit(env.sails.util.objCompact(inputs), 'criteria')).exec(function(err, records) {
      if (err) {
